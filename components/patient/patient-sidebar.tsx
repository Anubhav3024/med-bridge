...
import { UserIcon, Home, Stethoscope, Calendar, Settings, LogOut, X } from "lucide-react"
...
interface PatientSidebarProps {
  user: User
  activeNav: PatientNav
  onNavChange: (nav: PatientNav) => void
  onLogout: () => void
  isOpen: boolean
  onClose: () => void
}

export function PatientSidebar({ user, activeNav, onNavChange, onLogout, isOpen, onClose }: PatientSidebarProps) {
  const navItems = [
